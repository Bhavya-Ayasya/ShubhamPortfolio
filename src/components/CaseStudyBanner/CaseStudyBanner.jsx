...
//               {data?.heading}
//             </h1>
//             <p className="text-4xl font-semibold">{data?.subHeading}</p>
//           </div>

//           {data?.buttons?.[0] && (
//             <a
//               href={data?.buttons?.[0]?.link}
//               className="px-5 py-2 bg-orange-500 rounded-md font-medium"
//             >
...
//           {data?.thumbnails?.[0] && (
//             <div
//               className="relative w-full rounded-[60px] overflow-hidden cursor-pointer group"
//               style={{ height: "495px" }}
...
//                   className="absolute inset-0 m-auto w-20 h-20 opacity-90 group-hover:scale-110 transition"
//                   alt="Play"
//                 />
//               )}
//             </div>
...
//               <div
//                 key={idx}
//                 className="bg-[#1b1b1b] p-5 rounded-xl"
//               >
