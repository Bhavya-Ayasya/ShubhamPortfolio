...
//         {/* LEFT CONTENT */}
//         <div>
//           <h1 className="text-4xl font-bold mb-3">{contactData.title}</h1>
//           <p className="text-gray-400 mb-12">{contactData.subtitle}</p>

//           <div className="space-y-10">
//             {contactData.contactMethods.map((item, idx) => (
//               <div key={idx} className="flex items-start gap-4">
//                 <div className="bg-orange-600/20 text-orange-500 text-3xl p-4 rounded-full">
//                   {item.icon}
//                 </div>
//                 <div>
...
//               type="text"
//               placeholder="Name"
//               className="w-full bg-[#1a1a1a] text-white p-3 rounded-lg focus:ring-2 focus:ring-orange-500"
//             />
//             <input
//               type="email"
...
//             <button
//               type="submit"
//               className="w-full bg-orange-600 hover:bg-orange-700 transition text-white py-3 rounded-lg font-semibold"
//             >
//               Send Message
//             </button>
//           </form>
